  ...
  public: {
    Tables: {
      ...
      forum_answer_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "forum_answer_likes_answer_id_fkey"
            columns: ["answer_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "forum_answer_likes_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      forum_question_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "forum_question_likes_question_id_fkey"
            columns: ["question_id"]
            isOneToOne: false
            referencedRelation: "forum_questions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "forum_question_likes_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      forum_questions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "forum_questions_community_id_fkey"
            columns: ["community_id"]
            isOneToOne: false
            referencedRelation: "communities"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      post_category: "jdm" | "stance" | "drift" | "track" | "oldtimer"
    }
    CompositeTypes: {
      [_ in never]: never
    }
